// Implement a special queue that has three priority values (0, 1, 2), and it dequeues in increasing order (0 --> 1 --> 2).
// If no values are in the queue, return null. If there are two or more values of the same priority number, dequeue the
// first value that was inserted into the special queue.
